...
const m$ = StyleSheet.create({
  ...
  subtitle: { color: 'rgba(255,255,255,0.45)', fontSize: 13, marginBottom: 4 },
  input: {
  ...
  catTitle: { color: 'rgba(255,255,255,0.5)', fontSize: 10, fontWeight: '800', letterSpacing: 2, marginTop: 4 },
  catRow: { gap: 8, paddingVertical: 4 },
  catChip: {
    flexDirection: 'row', alignItems: 'center', gap: 4,
    paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, borderWidth: 1.5, borderColor: '#2A2A2A',
  },
  catLabel: { color: 'rgba(255,255,255,0.5)', fontSize: 9, fontWeight: '800', letterSpacing: 1 },
  createBtn: { backgroundColor: '#D4AF37', borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginTop: 8 },
  createBtnText: { color: '#050505', fontSize: 15, fontWeight: '900', letterSpacing: 2 },
...
const inv$ = StyleSheet.create({
  ...
  userXP: { color: 'rgba(255,255,255,0.4)', fontSize: 11, fontWeight: '600' },
  inviteBtn: { backgroundColor: '#00F2FF', borderRadius: 8, paddingHorizontal: 14, paddingVertical: 8 },
  inviteBtnText: { color: '#050505', fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  noResults: { color: 'rgba(255,255,255,0.4)', fontSize: 13, textAlign: 'center', padding: 20 },
  closeBtn: { marginTop: 12, alignItems: 'center', paddingVertical: 10 },
  closeText: { color: 'rgba(255,255,255,0.4)', fontSize: 14, fontWeight: '600' },
});
...
const hub$ = StyleSheet.create({
  ...
  inviteHdrText: { color: '#00F2FF', fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  ...
  statLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 9, fontWeight: '800', letterSpacing: 2 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  sectionTitle: { color: 'rgba(255,255,255,0.55)', fontSize: 10, fontWeight: '900', letterSpacing: 3, paddingHorizontal: 20, paddingTop: 20, paddingBottom: 10 },
  ...
  dnaLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 8, fontWeight: '800', letterSpacing: 1 },
  ...
  coachAvatarBorder: {},
  memberAvatarText: { color: '#050505', fontSize: 14, fontWeight: '900' },
  memberInfo: { flex: 1, gap: 3 },
  memberNameRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  memberName: { color: '#FFFFFF', fontSize: 14, fontWeight: '800' },
  memberSport: { color: 'rgba(255,255,255,0.4)', fontSize: 11, fontWeight: '600' },
  memberXP: { alignItems: 'center' },
  memberXPVal: { color: '#D4AF37', fontSize: 16, fontWeight: '900' },
  memberXPLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 8, fontWeight: '800', letterSpacing: 1 },
  emptyFeed: { color: 'rgba(255,255,255,0.3)', fontSize: 13, textAlign: 'center', padding: 24 },
  ...
  feedMsg: { color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: '600' },
  feedTime: { color: 'rgba(255,255,255,0.3)', fontSize: 10 },
});
...
export default function CrewsTab() {
  ...
  return (
    <View style={s.container} testID="crews-tab">
      <StatusBar barStyle="light-content" />
      <Header title={activeRole === 'COACH' ? 'MY STUDIO' : 'LA TRIBU'} />
      ...
      {selectedCrew && <CrewHub crew={selectedCrew} onClose={() => { setSelectedCrew(null); loadData(); }} token={token!} />}
    </View>
  );
}
...
const s = StyleSheet.create({
  ...
  inviteFrom: { color: 'rgba(255,255,255,0.5)', fontSize: 12, fontWeight: '600' },
  ...
  acceptText: { color: '#D4AF37', fontSize: 12, fontWeight: '900', letterSpacing: 1 },
  declineBtn: {
  ...
  crewStatText: { color: 'rgba(255,255,255,0.7)', fontSize: 11, fontWeight: '800', letterSpacing: 1 },
  fab: {
  ...
  fabText: { color: '#050505', fontSize: 14, fontWeight: '900', letterSpacing: 2 },
});
