...
const cd$ = StyleSheet.create({
  ...
  cityText: { color: '#00F2FF', fontSize: 10, fontWeight: '900', letterSpacing: 2 },
...
const pi$ = StyleSheet.create({
  ...
  username: { color: '#FFFFFF', fontSize: 18, fontWeight: '900', letterSpacing: 2, flex: 1 },
  founderBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: 'rgba(212,175,55,0.1)', borderRadius: 6, paddingHorizontal: 7, paddingVertical: 3, borderWidth: 1, borderColor: 'rgba(212,175,55,0.25)' },
  founderText: { color: '#D4AF37', fontSize: 8, fontWeight: '900', letterSpacing: 1.5 },
  sport: { color: 'rgba(255,255,255,0.4)', fontSize: 9, fontWeight: '700', letterSpacing: 2 },
  badgeRow: { flexDirection: 'row', gap: 6 },
  lvlBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: 'rgba(0,242,255,0.07)', borderRadius: 5, paddingHorizontal: 7, paddingVertical: 2, borderWidth: 1, borderColor: 'rgba(0,242,255,0.15)' },
  lvlText: { color: '#00F2FF', fontSize: 8, fontWeight: '900', letterSpacing: 1 },
  proBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: 'rgba(212,175,55,0.07)', borderRadius: 5, paddingHorizontal: 7, paddingVertical: 2, borderWidth: 1, borderColor: 'rgba(212,175,55,0.15)' },
  proText: { color: '#D4AF37', fontSize: 8, fontWeight: '900', letterSpacing: 1 },
  rankRow: { flexDirection: 'row', alignItems: 'center', gap: 16, paddingHorizontal: 16, paddingBottom: 14, paddingTop: 2 },
  rankLeft: { alignItems: 'center', gap: 2, minWidth: 60 },
  rankLabel: { color: 'rgba(255,255,255,0.3)', fontSize: 7, fontWeight: '900', letterSpacing: 3 },
  rankNum: { fontSize: 32, fontWeight: '900', letterSpacing: 2 },
  top10: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: 'rgba(212,175,55,0.1)', borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2 },
  top10Text: { color: '#D4AF37', fontSize: 7, fontWeight: '900', letterSpacing: 2 },
  rankDivider: { width: 1, height: 50, backgroundColor: 'rgba(255,255,255,0.05)' },
  rankRight: { flex: 1, gap: 8 },
  cityLabel: { color: 'rgba(255,255,255,0.25)', fontSize: 7, fontWeight: '900', letterSpacing: 3 },
  gapRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  gapText: { color: 'rgba(255,255,255,0.35)', fontSize: 8, fontWeight: '700', letterSpacing: 1 },
});
...
const kc$ = StyleSheet.create({
  ...
  brandSm: { color: 'rgba(255,255,255,0.25)', fontSize: 7, fontWeight: '800', letterSpacing: 4 },
  cardType: { color: '#00F2FF', fontSize: 11, fontWeight: '900', letterSpacing: 3 },
  founderBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(212,175,55,0.08)', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, borderWidth: 1, borderColor: '#D4AF37' },
  founderText: { color: '#D4AF37', fontSize: 8, fontWeight: '900', letterSpacing: 2 },
  dnaSection: { gap: 5 },
  dnaCap: { color: 'rgba(255,255,255,0.25)', fontSize: 7, fontWeight: '900', letterSpacing: 3, marginBottom: 4 },
  dnaRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  dnaLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 8, fontWeight: '900', letterSpacing: 1.5, width: 26 },
  dnaBar: { flex: 1, height: 3, backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 1.5, overflow: 'hidden' },
  dnaFill: { height: '100%', borderRadius: 1.5 },
  dnaVal: { fontSize: 10, fontWeight: '900', letterSpacing: 1, width: 26, textAlign: 'right' },
  ...
  bStat: { gap: 1 },
  bStatLabel: { color: 'rgba(255,255,255,0.25)', fontSize: 7, fontWeight: '800', letterSpacing: 2 },
  bStatVal: { color: '#FFFFFF', fontSize: 18, fontWeight: '900', letterSpacing: 1 },
  serial: { color: 'rgba(0,242,255,0.4)', fontSize: 8, fontWeight: '700', letterSpacing: 2 },
  ...
  btnInner: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 13, paddingHorizontal: 12 },
  btnSm: { color: 'rgba(255,255,255,0.3)', fontSize: 7, fontWeight: '700', letterSpacing: 1.5 },
  btnBig: { color: '#FFFFFF', fontSize: 12, fontWeight: '900', letterSpacing: 0.5 },
});
...
const xp$ = StyleSheet.create({
  ...
  barBg: { height: 5, backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 3, overflow: 'hidden', marginBottom: 6 },
