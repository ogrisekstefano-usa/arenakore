/**
 * HALL TAB — Build 21 · STEP-BY-STEP · Hello World
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.content}>
        ...
        <View style={s.divider} />
        <Text style={s.footer}>Hall Tab operativa · Nessun crash atteso</Text>
      </View>
    </SafeAreaView>
  );
}
...
const s = StyleSheet.create({
  ...
  title: { color: '#BF5AF2', fontSize: 28, fontWeight: '900', letterSpacing: -1 },
