...
const styles = StyleSheet.create({
  ...
  backText: { color: '#00E5FF', fontSize: 14, fontWeight: '800', letterSpacing: 1 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 24 },
  loadingText: { color: 'rgba(255,255,255,0.4)', fontSize: 13, fontWeight: '800', letterSpacing: 2, marginTop: 16 },
  enrollingCircle: {
    width: 80, height: 80, borderRadius: 40,
    backgroundColor: '#00E5FF22', alignItems: 'center', justifyContent: 'center',
    borderWidth: 2, borderColor: 'rgba(255,255,255,0.2)',
  },
  enrollingText: { color: '#00E5FF', fontSize: 16, fontWeight: '900', letterSpacing: 2, marginTop: 20 },
  enrollingSub: { color: 'rgba(255,255,255,0.4)', fontSize: 13, marginTop: 4 },
  // Success
  ...
  successTitle: { color: '#00E5FF', fontSize: 26, fontWeight: '900', letterSpacing: 4 },
  successSub: { color: 'rgba(255,255,255,0.6)', fontSize: 15, textAlign: 'center', fontWeight: '600' },
  gymBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    backgroundColor: 'rgba(255,215,0,0.1)', borderRadius: 10, paddingHorizontal: 24, paddingVertical: 8,
    borderWidth: 1, borderColor: 'rgba(255,215,0,0.2)',
  },
  gymBadgeText: { color: '#FFD700', fontSize: 14, fontWeight: '800', letterSpacing: 1 },
  xpBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    backgroundColor: 'rgba(255,215,0,0.08)', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6,
  },
  xpBadgeText: { color: '#FFD700', fontSize: 13, fontWeight: '900', letterSpacing: 1.5 },
  nexusBtn: { width: '100%', borderRadius: 12, overflow: 'hidden', marginTop: 8 },
  nexusBtnGrad: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    paddingVertical: 16,
  },
  nexusBtnText: { color: '#000000', fontSize: 16, fontWeight: '900', letterSpacing: 2 },
  // Preview
  ...
  previewHeaderText: { color: '#00E5FF', fontSize: 14, fontWeight: '900', letterSpacing: 3 },
  ...
  statusText: { color: '#FFD700', fontSize: 11, fontWeight: '900', letterSpacing: 1.5 },
  diffBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 3,
    paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, borderWidth: 1,
  },
  diffText: { fontSize: 10, fontWeight: '900', letterSpacing: 1 },
  previewTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '900', letterSpacing: 1 },
  previewDesc: { color: 'rgba(255,255,255,0.5)', fontSize: 14, lineHeight: 18 },
  previewInfoRow: { flexDirection: 'row', gap: 16, flexWrap: 'wrap' },
  infoItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  infoText: { color: 'rgba(255,255,255,0.6)', fontSize: 14, fontWeight: '700' },
  statsRow: { flexDirection: 'row', gap: 24 },
  statBlock: { flexDirection: 'row', alignItems: 'baseline', gap: 3 },
  statVal: { color: '#FFFFFF', fontSize: 22, fontWeight: '900' },
  statLabel: { color: 'rgba(255,255,255,0.30)', fontSize: 11, fontWeight: '800', letterSpacing: 1 },
  gymInfo: {
  ...
  gymName: { color: '#FFD700', fontSize: 16, fontWeight: '800' },
  ctaSection: { alignItems: 'center', gap: 10, marginTop: 4 },
  ctaLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 11, fontWeight: '800', letterSpacing: 2 },
  loginBtn: { width: '100%', borderRadius: 12, overflow: 'hidden' },
  loginBtnGrad: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    paddingVertical: 16,
  },
  loginBtnText: { color: '#000000', fontSize: 16, fontWeight: '900', letterSpacing: 2 },
  ctaSub: { color: 'rgba(255,255,255,0.3)', fontSize: 12, textAlign: 'center', fontWeight: '600' },
  // Error
  ...
  errorTitle: { color: '#FF3B30', fontSize: 20, fontWeight: '900', letterSpacing: 3 },
  errorMsg: { color: 'rgba(255,255,255,0.5)', fontSize: 15, textAlign: 'center', fontWeight: '600' },
  ...
  retryText: { color: '#FF3B30', fontSize: 14, fontWeight: '900', letterSpacing: 2 },
});
