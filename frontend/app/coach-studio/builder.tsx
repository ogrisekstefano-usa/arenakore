  ...
  return (
    <View style={[dc$.col, { borderColor: theme.border }]}>
      ...
      <View style={[dc$.header, { backgroundColor: theme.surface2 }]}>
        <Text style={[dc$.dayLabel, INTER('300'), { color: theme.textTer }]}>{dayLabel}</Text>
        <Text style={[dc$.dayNum, MONT('900'), { color: theme.text }]}>{dayNum}</Text>
        <Text style={[dc$.dayN, INTER('300'), { color: theme.textTer }]}>G{day.day}</Text>
      </View>
      ...
      {hasEvent && discMeta ? (
        <View style={[dc$.eventCard, { backgroundColor: discMeta.color + '14', borderColor: discMeta.color + '40' }]}>
          ...
          <Text style={[dc$.eventExercise, INTER('300'), { color: theme.textSec }]}>{day.exercise || discMeta.exercise}</Text>
          ...
          {day.notes ? <Text style={[dc$.eventNotes, INTER('300'), { color: theme.textTer }]} numberOfLines={2}>{day.notes}</Text> : null}
        </View>
      ) : (
        <TouchableOpacity style={[dc$.addBtn, { borderColor: theme.border }]} onPress={onAdd} activeOpacity={0.7}>
          ...
          <Text style={[dc$.addLabel, INTER('300'), { color: theme.textTer }]}>Aggiungi</Text>
        </TouchableOpacity>
      )}
    </View>
  );
...
function DayEventEditor({ day, onSave, onClose, theme }: {
  ...
  return (
    <Animated.View entering={FadeIn.duration(200)} style={[de$.panel, { backgroundColor: theme.surface, borderColor: theme.accent + '30' }]}>
      ...
      {/* Discipline selector */}
      <Text style={[de$.label, INTER('300'), { color: theme.textTer }]}>DISCIPLINA</Text>
      ...
      <View style={de$.targetsRow}>
        <View style={de$.targetField}>
          <Text style={[de$.label, INTER('300'), { color: theme.textTer }]}>REP TARGET</Text>
        ...
        <View style={de$.targetField}>
          <Text style={[de$.label, INTER('300'), { color: theme.textTer }]}>DURATA (sec)</Text>
      ...
      {/* Notes */}
      <Text style={[de$.label, INTER('300'), { color: theme.textTer }]}>NOTE COACH</Text>
...
function GlobalLeaderboardChart({ token }: { token: string }) {
  ...
  if (!leaderboard.length) return (
    <View style={[lb$.empty, { backgroundColor: theme.surface }]}>
      ...
      <Text style={[lb$.emptyText, INTER('300'), { color: theme.textTer }]}>
  ...
  return (
    <ScrollView style={lb$.scroll} contentContainerStyle={lb$.content}>
      <View style={[lb$.header, { borderBottomColor: theme.border }]}>
        ...
        <Text style={[lb$.headerSub, INTER('300'), { color: theme.textTer }]}>
    ...
    <ScrollView style={ae$.root} contentContainerStyle={ae$.content}>
      <View style={ae$.pageHeader}>
        <View>
          ...
          <Text style={[ae$.sub, INTER('300'), { color: theme.textTer }]}>
      ...
      {rules.length === 0 && (
        <View style={[ae$.empty, { backgroundColor: theme.surface }]}>
          ...
          <Text style={[ae$.emptyText, INTER('300'), { color: theme.textTer }]}>
          ...
          <Animated.View key={rule.id} entering={FadeInDown.delay(idx * 50).duration(200)}
            ...
            <View style={ae$.condRow}>
              ...
              <View style={ae$.condContent}>
                <Text style={[ae$.condLabel, INTER('300'), { color: theme.textSec }]}>Trigger:</Text>
                ...
                <View style={ae$.threshRow}>
                  <Text style={[ae$.threshLabel, INTER('300'), { color: theme.textSec }]}>Soglia:</Text>
                  <TextInput
                  ...
                  />
                  <Text style={[ae$.threshUnit, INTER('300'), { color: theme.textTer }]}>{trigMeta?.unit || '%'}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={ae$.condRow}>
              ...
              <View style={ae$.condContent}>
                <Text style={[ae$.condLabel, INTER('300'), { color: theme.textSec }]}>Azione:</Text>
                <View style={ae$.selectRow}>
                  {ACTION_META.map(a => (
      ...
      {rules.length > 0 && (
        <View style={[ae$.aiNote, { backgroundColor: theme.accent + '08', borderColor: theme.accent + '20' }]}>
          ...
          <Text style={[ae$.aiNoteText, INTER('300'), { color: theme.accent + 'CC' }]}>
            ...
            <ScrollView>
              {challenges.length === 0 && (
                <View style={mb$.emptySide}>
                  ...
                  <Text style={[mb$.emptySideText, INTER('300'), { color: theme.textTer }]}>Nessuna sfida creata</Text>
                </View>
              )}
              {challenges.map(c => (
                ...
                >
                  ...
                  <Text style={[mb$.challengeMeta, INTER('300'), { color: theme.textTer }]}>{c.duration_days} giorni · {c.days?.filter((d: any) => d.discipline).length || 0} eventi</Text>
                </TouchableOpacity>
              ))}
            </ScrollView>
          </View>
          ...
          <View style={mb$.mainArea}>
            {!selectedChallenge ? (
              <View style={mb$.noSelection}>
                ...
                <Text style={[mb$.noSelectionSub, INTER('300'), { color: theme.textTer }]}>Il tuo challenge builder multidisciplina</Text>
              </View>
            ) : tab === 'automation' ? (
              ...
              <ScrollView style={mb$.builderScroll} contentContainerStyle={mb$.builderContent}>
                ...
                <View style={mb$.challengeHeader}>
                  <View>
                    ...
                    <Text style={[mb$.challengeSubtitle, INTER('300'), { color: theme.textTer }]}>
                  ...
                  <View style={mb$.crewSelector}>
                    <Text style={[mb$.crewSelectorLabel, INTER('300'), { color: theme.textTer }]}>INVIA A CREW:</Text>
                    {crews.map(c => (
                      <TouchableOpacity key={c.id}
