...
const dc$ = StyleSheet.create({
  ...
  dayLabel: { fontSize: 11, letterSpacing: 2 },
  dayNum: { fontSize: 22 },
  dayN: { fontSize: 11, letterSpacing: 1 },
  ...
  removeBtn: { padding: 2 },
  eventDisc: { fontSize: 11, letterSpacing: 1.5, marginTop: 2 },
  eventExercise: { fontSize: 12, lineHeight: 13 },
...
const de$ = StyleSheet.create({
  ...
  discLabel: { fontSize: 12, letterSpacing: 1 },
...
const lb$ = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 20, letterSpacing: 3 },
  emptyText: { fontSize: 15, textAlign: 'center', lineHeight: 20, maxWidth: 280 },
  header: { borderBottomWidth: 1, paddingBottom: 12, gap: 4 },
  headerTitle: { fontSize: 18, letterSpacing: 3 },
  headerSub: { fontSize: 13, letterSpacing: 1 },
...
const ae$ = StyleSheet.create({
  ...
  sub: { fontSize: 13, letterSpacing: 0.5, marginTop: 3 },
  addBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 8, paddingHorizontal: 24, paddingVertical: 9 },
  addBtnText: { color: '#000', fontSize: 13, letterSpacing: 1.5 },
  empty: { borderRadius: 14, padding: 32, alignItems: 'center', gap: 12 },
  emptyTitle: { fontSize: 17, letterSpacing: 1 },
  emptyText: { fontSize: 14, textAlign: 'center', lineHeight: 18, maxWidth: 300 },
  ...
  ruleIndexText: { fontSize: 13 },
  ruleTitle: { flex: 1, fontSize: 14, letterSpacing: 1.5 },
  condRow: { flexDirection: 'row', gap: 10 },
  condBadge: { width: 52, height: 52, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  condBadgeText: { fontSize: 11, letterSpacing: 2 },
  condContent: { flex: 1, gap: 6 },
  condLabel: { fontSize: 12, letterSpacing: 1.5 },
  ...
  selectOptTxt: { fontSize: 11, letterSpacing: 1 },
  threshRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  threshLabel: { fontSize: 12, letterSpacing: 1.5 },
  threshInput: { width: 60, borderWidth: 1, borderRadius: 6, paddingHorizontal: 8, paddingVertical: 5, fontSize: 16, textAlign: 'center' } as any,
  threshUnit: { fontSize: 13 },
...
const mb$ = StyleSheet.create({
  ...
  tabLabel: { fontSize: 13, letterSpacing: 2 },
  ...
  sidePanelTitle: { fontSize: 13, letterSpacing: 2.5 },
  newForm: { margin: 8, borderRadius: 10, borderWidth: 1, padding: 10, gap: 8 },
  newInput: { borderWidth: 1, borderRadius: 7, paddingHorizontal: 10, paddingVertical: 7, fontSize: 15 } as any,
  newRow: { flexDirection: 'row', gap: 7, alignItems: 'center' },
  newDaysInput: { width: 50, borderWidth: 1, borderRadius: 7, paddingHorizontal: 8, paddingVertical: 7, fontSize: 15, textAlign: 'center' } as any,
  createBtn: { flex: 1, borderRadius: 7, paddingVertical: 8, alignItems: 'center' },
  createBtnText: { fontSize: 13, letterSpacing: 2 },
  emptySide: { alignItems: 'center', paddingTop: 30, gap: 8 },
  emptySideText: { fontSize: 13 },
  ...
  challengeStatusText: { fontSize: 10, letterSpacing: 1.5 },
  challengeName: { fontSize: 14, letterSpacing: 0.5 },
  challengeMeta: { fontSize: 11, letterSpacing: 0.3 },
  mainArea: { flex: 1 },
  noSelection: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12 },
  noSelectionText: { fontSize: 18, letterSpacing: 2 },
  noSelectionSub: { fontSize: 14 },
  ...
  challengeTitle: { fontSize: 20, letterSpacing: 2 },
  challengeSubtitle: { fontSize: 13, letterSpacing: 0.5, marginTop: 3 },
  crewSelector: { flexDirection: 'row', alignItems: 'center', gap: 8, flexWrap: 'wrap' },
  crewSelectorLabel: { fontSize: 11, letterSpacing: 2 },
  ...
  crewOptText: { fontSize: 11, letterSpacing: 1.5 },
  timelineSection: { gap: 8 },
  timelineLabel: { fontSize: 11, letterSpacing: 3 },
