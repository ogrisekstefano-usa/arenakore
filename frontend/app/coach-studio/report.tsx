...
import { useTheme, MONT, INTER, PJS } from '../../contexts/ThemeContext';
      ...
      >
        ...
        <View style={rp$.identity}>
          ...
          <View style={rp$.identInfo}>
            ...
            <Text style={[rp$.athleteMeta, INTER('300'), { color: 'rgba(255,255,255,0.5)' }]}>
        ...
        <View style={rp$.bottomRow}>
          ...
          {injury_risk && (
            <View style={[rp$.injuryCard, { borderColor: injury_risk.color + '30' }]}>
              ...
              <Text style={[rp$.injuryRec, INTER('300')]}>{injury_risk.recommendation}</Text>
            </View>
          )}
        </View>
        ...
        <View style={rp$.cardFooter}>
          <Text style={[rp$.footerText, INTER('300')]}>
            Generato da {report.generated_by?.toUpperCase()} · NÈXUS Intelligence Platform
          </Text>
          <Text style={[rp$.footerText, INTER('300')]}>ID #{athlete.id?.slice(-8).toUpperCase()}</Text>
        </View>
      </Animated.View>
    </ScrollView>
  );
