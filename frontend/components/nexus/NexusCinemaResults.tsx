...
const cin$ = StyleSheet.create({
  ...
  title: { color: '#00E5FF', fontSize: 11, fontWeight: '800', letterSpacing: 4 },
  ...
  scoreCircle: { width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(0,229,255,0.65)', borderWidth: 3, borderColor: '#00E5FF', alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  ...
  xpPlus: { color: '#FFD700', fontSize: 22, fontWeight: '300' },
  ...
  recordTitle: { color: '#FFD700', fontSize: 11, fontWeight: '800', letterSpacing: 2 },
  recordList: { color: '#FFD700', fontSize: 10 },
  level: { width: '100%', backgroundColor: 'rgba(0,229,255,0.65)', borderRadius: 10, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.3)', marginBottom: 8 },
  levelText: { color: '#00E5FF', fontSize: 12, fontWeight: '800', letterSpacing: 1 },
  dnaRow: { flexDirection: 'row', gap: 10, marginVertical: 8 },
  dnaItem: { alignItems: 'center', gap: 1 },
  dnaVal: { color: '#00E5FF', fontSize: 14, fontWeight: '900' },
  ...
  shareBtnText: { color: '#FFD700', fontSize: 11, fontWeight: '800', letterSpacing: 2 },
  ...
  shareLogo: { color: '#FFD700', fontSize: 16, fontWeight: '900', letterSpacing: 4 },
  ...
  shareFounder: { color: '#FFD700', fontSize: 10, fontWeight: '600', fontStyle: 'italic', textAlign: 'center' },
  closeBtn: { width: '100%', backgroundColor: '#00E5FF', borderRadius: 10, paddingVertical: 14, alignItems: 'center', marginTop: 10 },
  closeBtnText: { color: '#000000', fontSize: 14, fontWeight: '800', letterSpacing: 2 },
});
