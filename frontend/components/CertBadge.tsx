...
const dw$ = StyleSheet.create({
  ...
  lockedTitle: { color: '#FFD700', fontSize: 14, fontWeight: '900', letterSpacing: 1 },
  lockedSub: { color: '#AAAAAA', fontSize: 13, fontWeight: '300', lineHeight: 16 },
  ...
  certBtnText: { color: '#000', fontSize: 13, fontWeight: '900', letterSpacing: 1.5 },
  // Active wallet
  card: {
    marginHorizontal: 24, marginBottom: 10,
  ...
  balanceUnit: { color: '#00E5FF22', fontSize: 14, fontWeight: '900', letterSpacing: 2, marginBottom: 6 },
  earnHint: { color: 'rgba(255,255,255,0.30)', fontSize: 13, fontWeight: '300' },
