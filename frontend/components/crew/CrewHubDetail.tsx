...
const hub$ = StyleSheet.create({
  ...
  backText: { color: '#00E5FF', fontSize: 17, fontWeight: '800', letterSpacing: 1 },
  headerRight: {},
  ...
  inviteHdrText: { color: '#00E5FF', fontSize: 15, fontWeight: '900', letterSpacing: 1 },
  ...
  catBadgeText: { fontSize: 14, fontWeight: '900', letterSpacing: 1 },
  crewName: { color: '#FFFFFF', fontSize: 28, fontWeight: '900', letterSpacing: 0.5 },
  crewTagline: { color: 'rgba(255,255,255,0.5)', fontSize: 19, fontStyle: 'italic' },
  statsRow: { flexDirection: 'row', gap: 24, marginTop: 10 },
  stat: { gap: 1 },
  statVal: { color: '#FFFFFF', fontSize: 24, fontWeight: '900' },
  statLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 14, fontWeight: '800', letterSpacing: 2 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  sectionTitle: { color: '#AAAAAA', fontSize: 15, fontWeight: '900', letterSpacing: 3, paddingHorizontal: 20, paddingTop: 20, paddingBottom: 10 },
  dnaRow: { flexDirection: 'row', justifyContent: 'space-around', paddingHorizontal: 24, paddingBottom: 8 },
  dnaItem: { alignItems: 'center', gap: 2 },
  dnaVal: { color: '#00E5FF', fontSize: 20, fontWeight: '900' },
  dnaLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 13, fontWeight: '800', letterSpacing: 1 },
  ...
  coachAvatarBorder: {},
  memberAvatarText: { color: '#000000', fontSize: 19, fontWeight: '900' },
  memberInfo: { flex: 1, gap: 3 },
  memberNameRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  memberName: { color: '#FFFFFF', fontSize: 19, fontWeight: '800' },
  memberSport: { color: 'rgba(255,255,255,0.4)', fontSize: 16, fontWeight: '400' },
  memberXP: { alignItems: 'center' },
  memberXPVal: { color: '#FFD700', fontSize: 18, fontWeight: '900' },
  memberXPLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 13, fontWeight: '800', letterSpacing: 1 },
  emptyFeed: { color: 'rgba(255,255,255,0.3)', fontSize: 18, textAlign: 'center', padding: 24 },
