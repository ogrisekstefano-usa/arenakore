...
const dna$ = StyleSheet.create({
  ...
  label: { color: '#AAAAAA', fontSize: 13, fontWeight: '700', letterSpacing: 1.5, width: 32 },
...
const m$ = StyleSheet.create({
  ...
  sideName: { color: '#FFFFFF', fontSize: 15, fontWeight: '900', letterSpacing: 1 },
  sideAvg: { color: 'rgba(255,255,255,0.6)', fontSize: 28, fontWeight: '900' },
  sideWin: { color: '#00E5FF' },
  sideLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 11, fontWeight: '700', letterSpacing: 2 },
  vsCenter: { alignItems: 'center', paddingHorizontal: 12, gap: 4 },
  vs: { color: '#FFD700', fontSize: 18, fontWeight: '900', letterSpacing: 3 },
  ...
  dnaSectionTitle: { color: '#00E5FF22', fontSize: 11, fontWeight: '900', letterSpacing: 3, marginBottom: 10 },
