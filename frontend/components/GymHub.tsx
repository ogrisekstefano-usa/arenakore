...
const ev$ = StyleSheet.create({
  ...
  desc: { color: 'rgba(255,255,255,0.5)', fontSize: 12, lineHeight: 18 },
  infoRow: { flexDirection: 'row', gap: 14, flexWrap: 'wrap' },
  infoItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  infoText: { color: 'rgba(255,255,255,0.6)', fontSize: 11, fontWeight: '700' },
...
const hub$ = StyleSheet.create({
  ...
  emptySub: { color: 'rgba(255,255,255,0.25)', fontSize: 12, fontWeight: '600', textAlign: 'center' },
});
