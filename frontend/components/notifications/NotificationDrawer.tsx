...
const styles = StyleSheet.create({
  ...
  notifTitle: { flex: 1, color: '#AAAAAA', fontSize: 16, fontWeight: '800', letterSpacing: 1 },
  notifTitleUnread: { color: '#FFFFFF' },
  unreadDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: '#00E5FF' },
  notifBody: { color: 'rgba(255,255,255,0.4)', fontSize: 17, lineHeight: 17, fontWeight: '500' },
  notifTime: { color: 'rgba(255,255,255,0.2)', fontSize: 14, fontWeight: '700', letterSpacing: 1, marginTop: 2 },
