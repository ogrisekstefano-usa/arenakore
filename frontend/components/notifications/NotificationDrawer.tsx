...
const styles = StyleSheet.create({
  ...
  panelTitle: { color: '#FFFFFF', fontSize: 13, fontWeight: '900', letterSpacing: 3 },
  unreadBadge: {
  ...
  notifTitle: { flex: 1, color: 'rgba(255,255,255,0.55)', fontSize: 11, fontWeight: '800', letterSpacing: 1 },
  notifTitleUnread: { color: '#FFFFFF' },
  unreadDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: '#00F2FF' },
  notifBody: { color: 'rgba(255,255,255,0.4)', fontSize: 12, lineHeight: 17, fontWeight: '500' },
  notifTime: { color: 'rgba(255,255,255,0.2)', fontSize: 9, fontWeight: '700', letterSpacing: 1, marginTop: 2 },
