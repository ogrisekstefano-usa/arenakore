...
# ═════════════════════════════════════════════════════════════════════════════
# SUPER ADMIN PANEL — Extracted to routes/admin.py
# ═════════════════════════════════════════════════════════════════════════════
from routes.admin import register_admin_routes
register_admin_routes(api_router, db, require_super_admin, get_current_user, hash_password)


# NOTE: The inline admin code has been removed.
# All admin endpoints now live in routes/admin.py:
#   GET  /admin/dashboard
#   GET  /admin/leads
#   PATCH /admin/leads/{id}/activate
